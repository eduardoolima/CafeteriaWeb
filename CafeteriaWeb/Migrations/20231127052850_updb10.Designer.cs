...
namespace CafeteriaWeb.Migrations
{
    ...
    [Migration("20231127052850_updb10")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CafeteriaWeb.Models.CategorySupplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CafeteriaWeb.Models.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CafeteriaWeb.Models.Feedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CafeteriaWeb.Models.Supplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CafeteriaWeb.Models.Supplier", b =>
                {
                    b.HasOne("CafeteriaWeb.Models.CategorySupplier", "CategorySupplier")
                        .WithMany("Suppliers")
                        .HasForeignKey("CategorySupplierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CategorySupplier");
                });
