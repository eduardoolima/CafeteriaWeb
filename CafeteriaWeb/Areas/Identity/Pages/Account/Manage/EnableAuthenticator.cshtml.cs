...
namespace CafeteriaWeb.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(7, ErrorMessage = "O {0} precisa ter pelo menos {2} e no maximo {1} caracteres.", MinimumLength = 6)]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!is2faTokenValid)
            {
                ModelState.AddModelError("Input.Code", "O código de verificação é invalido.");
                await LoadSharedKeyAndQrCodeUriAsync(user);
                return Page();
            }
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("CafeteriaWeb"),
